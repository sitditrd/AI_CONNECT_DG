...
(function () {
  ...
  var SCOPE = [
    ...
    { area: '③ 법규 검증 · 창고 매칭', rows: [
      ...
      { f: 'CAS 단위 허가 품목 대조', s: '부분', now: '창고 허가 품목(CAS)과 MSDS 성분 대조 — 시연 매핑 3곳', next: '유해화학물질 고시 목록 연동 · 전 창고 허가 품목 등록', href: 'matching.html' },
      { f: '담당자 확인 전환', s: '구현', now: '12개 전환 기준 — 사유가 남으면 승인 후에도 조건부', next: '승인 권한 · 이력 관리', href: 'compliance.html' },
  ...
  var DOC_STEPS = [
    { t: '자동 검사', d: '필수 필드 누락 · 신뢰도 80% 미만 · 인식 적합도 85점 미만 · CAS 체크디짓 · 농도와 분류 상충', s: '구현' },
